...
export const createHTMLTamplate = (name, code, isPassword) => {
  return `<div>
          <h3>Hi ${name},</h3> 
          ...
          <p>Please enter this OTP code on Saukie.net when prompted</p>
          <h2>${code}</h2>
...
export const sender = `Saukie Telecom <hello@saukie.net>`;
