import { Box, Text as Txt } from '@chakra-ui/react';

const Text = ({ children }) => <Txt lineHeight={2}>{children}</Txt>;

let name = 'Choice Data Services';
let site_address = 'choicedataservices.com';
...
const Terms = () => {
  return (
    <Box m={3} mt={5} mb={5}>
      ...
      <Text>Last updated: 2023-05-10</Text>
      <Text>
        1. <b>Introduction</b>
      </Text>
      <Text>
        Welcome to <b>{name}</b> (“Company”, “we”, “our”, “us”)!
      </Text>
      <Text>
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of
        our website located at <b>{site_address}</b> (together or individually
        “Service”) operated by <b>{name}</b>.
      </Text>
      <Text>
      ...
      <Text>
        ...
        <b>hello@{site_address}</b> so we can try to find a solution. These
      ...
      <Text>
        ...
        following the unsubscribe link or by emailing at hello@{site_address}.
      </Text>
      <Text>
        3. <b>Purchases</b>
      </Text>
      ...
      <Text>
        ...
        {name} cancels it. You may cancel your Subscription renewal either
        through your online account management page or by contacting hello@
        {site_address} customer support team.
      </Text>
      <Text>
        A valid payment method is required to process the payment for your
        subscription. You shall provide {name} with accurate and complete
        ...
        automatically authorize {name} to charge all Subscription fees incurred
      ...
      <Text>
        {name} may, at its sole discretion, offer a Subscription with a free
      ...
      <Text>
        ...
        you will not be charged by {name} until Free Trial has expired. On the
      ...
      <Text>
        At any time and without notice, {name} reserves the right to (i) modify
      ...
      <Text>
        {name}, in its sole discretion and at any time, may modify Subscription
        fees for the Subscriptions. Any Subscription fee change will become
        effective at the end of the then-current Billing Cycle.
      </Text>
      <Text>
        {name} will provide you with a reasonable prior notice of any change in
      ...
      <Text>
        We issue refunds for Contracts within <b>1 days</b> of the original
      ...
      <Text>
        ...
        {name} or used with permission. You may not distribute, modify,
      ...
      <Text>
        ...
        {name} and its licensors. Service is protected by copyright, trademark,
        and other laws of and foreign countries. Our trademarks may not be used
      ...
      <Text>
        ...
        to hello@{site_address}, with the subject line: “Copyright Infringement”
      ...
      <Text>
        You can contact our Copyright Agent via email at hello@{site_address}.
      </Text>
      <Text>
        17. <b>Error Reporting and Feedback</b>
      </Text>
      <Text>
        You may provide us either directly at hello@{site_address} or via third
      ...
      <Text>
        ...
        are not owned or controlled by {name}.
      </Text>
      <Text>
      ...
      >
        ...
        were created for <b>{site_address}</b> by{' '}
        <a href='https://policymaker.io'>PolicyMaker.io</a> on 2023-05-10.
      </p>
    </Box>
  );
};
