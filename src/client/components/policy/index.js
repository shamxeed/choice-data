...
const Policy = () => {
  return (
    <Box m={3} mt={5} mb={5}>
      ...
      <Text>Effective date: 2023-05-10</Text>
      <Text>
        1. <b>Introduction</b>
      </Text>
      <Text>
      ...
      <Text>
        <b>{name}</b> (“us”, “we”, or “our”) operates <b>{site_address}</b>{' '}
        (hereinafter referred to as <b>“Service”</b>).
      </Text>
      <Text>
        Our Privacy Policy governs your visit to <b>{site_address}</b>, and
      ...
      <Text>
        <b>SERVICE</b> means the {site_address} website operated by {name}.
      </Text>
      <Text>
      ...
      <Text>0.1. Email address</Text>
      <Text>0.2. First name and last name</Text>
      <Text>0.3. Phone number</Text>
      <Text>0.4. Address, Country, State, Province, ZIP/Postal code, City</Text>
      <Text>0.5. Cookies and Usage Data</Text>
      <Text>
      ...
      <Text>{name} uses the collected data for various purposes:</Text>
      <Text>0.1. to provide and maintain our Service;</Text>
      <Text>0.2. to notify you about changes to our Service;</Text>
      <Text>
        0.3. to allow you to participate in interactive features of our Service
        when you choose to do so;
      </Text>
      <Text>0.4. to provide customer support;</Text>
      <Text>
        0.5. to gather analysis or valuable information so that we can improve
        our Service;
      </Text>
      <Text>0.6. to monitor the usage of our Service;</Text>
      <Text>0.7. to detect, prevent and address technical issues;</Text>
      <Text>0.8. to fulfil any other purpose for which you provide it;</Text>
      <Text>
      ...
      <Text>0.13. for any other purpose with your consent.</Text>
      <Text>
      ...
      <Text>
        {name} will take all the steps reasonably necessary to ensure that your
      ...
      <Text>0.2.1. to our subsidiaries and affiliates;</Text>
      <Text>
        0.2.2. to contractors, service providers, and other third parties we use
        to support our business;
      </Text>
      <Text>0.2.3. to fulfill the purpose for which you provide it;</Text>
      <Text>
      ...
      <Text>0.2.6. with your consent in any other cases;</Text>
      <Text>
      ...
      <Text>According to CalOPPA we agree to the following:</Text>
      <Text>0.1. users can visit our site anonymously;</Text>
      <Text>
      ...
      <Text>
        ...
        at <b>hello@{site_address}</b>.
      </Text>
      <Text>Our Policy on “Do Not Track” Signals:</Text>
      <Text>
      ...
      <Text>
        ...
        please send your request(s) by email: <b>hello@{site_address}</b>.
      </Text>
      <Text>
      ...
      <Text>
        ...
        by email: <b>hello@{site_address}</b>.
      </Text>
      <p
        style={{
          marginTop: '5em',
      ...
      >
        ...
        was created for <b>{site_address}</b> by{' '}
